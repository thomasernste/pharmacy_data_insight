...
def filter_pharm_data(input_data_txt, output_data_txt):
    ...
    with open(input_data_txt, 'r') as pharm_file:
        reader = csv.reader(pharm_file)
    ...
    # This code writes the data one row at a time to the output .txt file
...
def main():
    ...
    filter_pharm_data(input_data_csv, output_data_csv)
